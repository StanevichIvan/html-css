...
$(document).ready(function () {
    ...
    $(document).on('click', '.slider-control__right', function () {
        mainSlider.trigger('next.owl.carousel', [300]);
    });
    $(document).on('click', '.slider-control__left', function () {
    ...
    $(document).on('click', '.typed-slider__controls_left', function () {
        typedSlider.trigger('prev.owl.carousel', [300]);
    });
    $(document).on('click', '.typed-slider__controls_right', function () {
    ...
    $(document).on('click', '.js-slider-about-prev', function () {
        aboutUsSlider.trigger('prev.owl.carousel', [300]);
    });
    $(document).on('click', '.js-slider-about-next', function () {
    ...
    $(document).on('click', '.js-prod-desc_prev', function () {
        projectSlider.trigger('prev.owl.carousel', [300]);
    });
    $(document).on('click', '.js-prod-desc_next', function () {
    ...
    $(document).on('click', '.popup__close-cross, .popup-bg', function () {
        $(".popup").fadeOut("fast");
        $(".popup-bg").fadeOut("fast");
    });
    //popup error
    $(".popup__input input").focusout(function (event) {
    ...
    $(".popup__input input").keyup(function (event) {
        var $this = $(event.target);
        if ($this.val().length != 0) {
            $this.parent().removeClass("active");
        }
    ...
    $(document).on('click', ".popup__form-submit", function (event) {
        var $this = $(event.target);
    ...
    $(document).on('click', '.js-all-properties', function (event) {
        $(".item-card__charasterisric-wrap").toggleClass("active");
    });
    $(document).on('click', '.js-item-mobile-properties__head', function (event) {
        $(".js-item-mobile-properties__drop-list").toggleClass("active");
    });
    $(document).on('click', '.js-item-card-list', function (event) {
        $(".item-card-list").toggleClass("active");
    });

    $(document).on('click', '.product-description-slider__zoom , .run-fullscreen-slider', function (event) {
        $("#start-lightgallery").click();
    });

    $(document).on('click', '.js-show-collapse', function (event) {
        event.preventDefault();
        $(event.target).siblings(".js-collapsed-block").toggleClass("active");
    });

    //catalog filter
    $(document).on("click", ".js-catalog-filter-drop", function (event) {
    ...
    function resizeCombine() {
        ...
        $(document).on('click', '.owl-contacts-left', function () {
            owlContacts.trigger('prev.owl.carousel', [300]);
        });
        $(document).on('click', '.owl-contacts-right', function () {
        ...
        $(document).on('click', '.owl-stock-right', function () {
            owlStock.trigger('next.owl.carousel', [300]);
        });
        $(document).on('click', '.owl-stock-left', function () {
    ...
    $(document).on('click', '.js-table-show-all', function (event) {
        var regular = 'Показать всю продукцию',
            active = 'Скрыть';
        var $this = event.target;
    ...
    $(document).on('onfocus', '.js-table-drop', function (event) {});

    $('.js-table-drop').hover(function (event) {
    ...
    if ($(".slider-jq").length) {
        ...
        $(document).on('keyup', '.slide-bar__banner', function (event) {
            var $this = $(event.target);
    ...
    //catalog droplist
    $(document).on('click', '.js-catalog-checkbox', function (event) {
        $(event.target).toggleClass("active");
    });
    ...
    if (window.width < 1160) {
        $(document).on("click", ".js-table-drop", function (event) {
